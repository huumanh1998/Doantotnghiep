...
<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
        $quanti = 0;
        $get_product_details = $product->get_details($_POST['productId']);
        ...
        $cartId = $_POST['cartId'];
        $quantity = min(max (0, $_POST['quantity']), $quanti);
...
<section class="shopping-cart">
    ...
    <h1 class="heading"><span style="text-transform: none;">Giỏ hàng của bạn</span></h1>
           ...
           <?php
            ...
            ?>              
             ...
             <?php
                    ...
                    ?>
                        <div class="btn"><a class="muahang" style="color: white;" href="payment.php">Thanh toán</a></div>
                    ...
                    <style type="text/css">
                        ...
                        <div class="btn"><a  style="text-align: center;color: white;" href="login.php"> Mua hàng</a></div>
                    <?php
                    } 
                    ?>
        </div>
