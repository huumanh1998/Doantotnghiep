        ...
        ?>     
         <form action="" method="post" enctype="multipart/form-data">
            <table class="form">
				...
				<tr>
                    <td>
                        <label>Cập nhật ảnh phụ 1</label>
                    </td>
                    <td>
                        <img src="uploads/<?php echo $result_product['image1'] ?>" width="90"><br>
                        <input type="file" name="image1" />
                    </td>
                </tr>
                <tr>
                    <td>
                        <label>Cập nhật ảnh phụ 2</label>
                    </td>
                    <td>
                        <img src="uploads/<?php echo $result_product['image2'] ?>" width="90"><br>
                 ...
                 <tr>
                    ...
                    <td>
                       <input type="number" name="quanti" min="0" value="<?php echo $result_product['quanti'] ?>"/>
                    </td>
                </tr>
				<!-- <tr>
                    <td>
